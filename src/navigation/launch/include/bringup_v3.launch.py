...
# Parallel copy of bringup.launch.py / bringup_v2.launch.py that includes
# navigation_base_v3.launch.py (v3 controller selectable) instead. Does not touch the
# v1/v2 files.
...
def launch_setup(context):
    ...
    bringup_cmd_group = GroupAction([
        ...
        IncludeLaunchDescription(
            PythonLaunchDescriptionSource(os.path.join(navigation_package_path, 'launch/include/navigation_base_v3.launch.py')),
            launch_arguments={'namespace': namespace,
                              'use_namespace': use_namespace,
                              'use_sim_time': use_sim_time,
                              'autostart': autostart,
