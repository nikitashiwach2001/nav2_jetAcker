...
def launch_setup(context):
    ...
    declare_use_rl_cmd = DeclareLaunchArgument(
        ...
        description='Use the RL (ONNX) Ackermann controller instead of TEB/DWB')
    ...
    load_composable_nodes = LoadComposableNodes(
        ...
        composable_node_descriptions=[
            ...
            ComposableNode(
                ...
                parameters=[params_file],
                remappings=remappings + [('cmd_vel', 'cmd_vel_nav')]),
            # Collision monitor sits last in the cmd_vel chain:
            # controller -> cmd_vel_nav -> velocity_smoother -> cmd_vel_smoothed -> collision_monitor -> cmd_vel
            ComposableNode(
