...
# Parallel copy of navigation_base.launch.py that can select the new (v2) RL controller plugin
# (rl_nav_cpp/RLControllerV2, config/nav2_controller_rl_v2.yaml) via use_rl_v2:=true, without
# touching navigation_base.launch.py / the original v1 controller path.
...
def launch_setup(context):
    ...
    declare_use_rl_v2_cmd = DeclareLaunchArgument(
        ...
        description='Use the RL v2 (ONNX, reverse-capable) Ackermann controller. '
                     'Takes priority over use_rl/use_teb if true.')
