...
# Parallel copy of navigation_base.launch.py / navigation_base_v2.launch.py that can select
# the v3 RL controller plugin (rl_nav_cpp/RLControllerV3, config/nav2_controller_rl_v3.yaml)
# via use_rl_v3:=true, without touching the v1/v2 files.
