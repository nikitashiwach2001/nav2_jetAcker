...
def launch_setup(context):
    ...
    # RViz "Publish Point" -> goal with auto heading (robot->goal direction), so Hybrid-A*
    # doesn't loop around to honor an arbitrarily dragged Nav2 Goal arrow heading
    ...
    return [sim_arg, map_name_arg, master_name_arg, robot_name_arg, use_teb_arg, use_rl_arg, bringup_launch]
