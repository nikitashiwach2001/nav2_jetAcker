...
# Parallel copy of navigation.launch.py / navigation_v2.launch.py that boots the v3 RL
# controller stack (rl_nav_cpp/RLControllerV3, config/nav2_controller_rl_v3.yaml,
# carrot_l6.onnx) via bringup_v3.launch.py. Does not touch the v1/v2 files.
#
# Usage: ros2 launch navigation navigation_v3.launch.py use_rl_v3:=true
...
def launch_setup(context):
    ...
    use_rl_v3 = LaunchConfiguration('use_rl_v3', default='true').perform(context)
    ...
    navigation_launch = IncludeLaunchDescription(
        PythonLaunchDescriptionSource(os.path.join(navigation_package_path, 'launch/include/bringup_v3.launch.py')),
        launch_arguments={
    ...
    return [sim_arg, map_name_arg, master_name_arg, robot_name_arg, use_teb_arg, use_rl_arg,
            use_rl_v2_arg, use_rl_v3_arg, bringup_launch]
