...
# Parallel copy of navigation_v3.launch.py that boots the v4 RL controller stack
# (rl_nav_cpp/RLControllerV4, config/nav2_controller_rl_v4.yaml,
# policy_v4_model6998.onnx) via bringup_v4.launch.py. Does not touch the v1/v2/v3 files.
#
# Usage: ros2 launch navigation navigation_v4.launch.py use_rl_v4:=true
...
def launch_setup(context):
    ...
    use_rl_v4 = LaunchConfiguration('use_rl_v4', default='true').perform(context)
    ...
    navigation_launch = IncludeLaunchDescription(
        PythonLaunchDescriptionSource(os.path.join(navigation_package_path, 'launch/include/bringup_v4.launch.py')),
        launch_arguments={
    ...
    return [sim_arg, map_name_arg, master_name_arg, robot_name_arg, use_teb_arg, use_rl_arg,
            use_rl_v2_arg, use_rl_v3_arg, use_rl_v4_arg, bringup_launch]
